...
static bool push_args_to_stack(struct pt_regs *pt_regs, struct memorizer_kobj*
...
static void update_stack_kobj(struct EdgeBucket *new_bucket, struct pt_regs *pt_regs)
{
...
static void create_stack_kobj(uintptr_t to, struct EdgeBucket *new_bucket, struct pt_regs *pt_regs)
{
#if defined(__x86_64__)
