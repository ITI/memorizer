...
__always_inline void track_l1_alloc(void){inca(&num_l1);};
__always_inline void track_l2_alloc(void){inca(&num_l2);};
__always_inline void track_l3_alloc(void){inca(&num_l3);};
...
__always_inline void track_disabled_alloc(void) { inca(&num_allocs_while_disabled); }
__always_inline void track_induced_alloc(void) { inca(&num_induced_allocs); }
__always_inline void track_free(void) { inca(&stats_frees); }
__always_inline void track_untracked_obj_free(void) { inca(&stats_untracked_obj_frees); }
__always_inline void track_induced_free(void) { inca(&num_induced_frees); }
__always_inline void track_kobj_free(void) { inca(&stats_kobj_frees); }
__always_inline void track_kobj_alloc_reuse(void) { inca(&stats_kobj_alloc_reuse); }
__always_inline void track_kobj_alloc_memalloc(void) { inca(&stats_kobj_alloc_memalloc); }
__always_inline void track_afc_alloc_reuse(void) { inca(&stats_afc_alloc_reuse); }
__always_inline void track_afc_alloc_memalloc(void) { inca(&stats_afc_alloc_memalloc); }
__always_inline void track_failed_kobj_alloc(void) { inca(&failed_kobj_allocs); }
__always_inline void track_access_counts_alloc(void) { inca(&num_access_counts); }

__always_inline void track_alloc(enum AllocType AT)
{
    if (AT > NumAllocTypes) {
...
static void lt_pr_stats_seq(struct seq_file *seq)
{
    int64_t l3s = 1;
    int64_t l2s = geta(&num_l2);
    int64_t l1s = geta(&num_l1);
